# A Blacklight::Solr::Document::Extension that allows us to export Hydra objects as PBCore xml
# 
...
# format is called.
module Rockhall::Pbcore
  def self.extended(document)
    Rockhall::Pbcore.register_export_formats( document )
  end
