...
Description:
  ...
  Scenario: Reviewer metdata getting wiped out (DAM-148)
    ...
    And I should see the field title "blacklight-reviewer_ssm" contain "Reviewer"
    And I should see the field content "blacklight-reviewer_ssm" contain "reviewer1@example.com"
    And I should see the field title "blacklight-abstract_ssm" contain "Abstract"
    And I should see the field content "blacklight-abstract_ssm" contain "We don't have permission to show this to the public"