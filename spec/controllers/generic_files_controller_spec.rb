  ...
  describe "when the user is signed in" do
    ...
    describe "#create" do
      ...
      before :each do
        ...
        FileUtils.copy("spec/fixtures/images/rrhof.jpg", @mock_upload_directory)
      ...
      it "should create and save a file asset from the given params" do
        ...
        file = fixture_file_upload("spec/fixtures/images/rrhof.tif","image/tiff")
        xhr :post, :create, :files=>[file], :Filename=>"Rockhall", :batch_id => "sample:batch_id", :permission=>{"group"=>{"public"=>"read"} }, :terms_of_service => "1"
        GenericFile.count.should == 1
        saved_file = GenericFile.first
        # This is confirming that the correct file was attached
        saved_file.label.should == "rrhof.tif"
        saved_file.content.checksum.should == "2ad8db2ef38fca60f7180a88acf6e1c5134d9c5b"
