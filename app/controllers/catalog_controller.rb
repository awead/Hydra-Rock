class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_show_field solr_name('subject', :displayable),               :label => 'Subject', :helper_method => :subject_display
    ...
    config.add_show_field solr_name('additional_collection', :displayable), :label => 'Additional Collection'
