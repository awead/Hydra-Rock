class RockhallDigitalDocument < HydraPbcore::Datastream::Deprecated::DigitalDocument

  include Rockhall::WorkflowMethods
  
  @terminology = HydraPbcore::Datastream::Deprecated::DigitalDocument.terminology
