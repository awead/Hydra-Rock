class EadDocument < ActiveFedora::OmDatastream
  ...
  set_terminology do |t|
    ...
    t.title_filing(:path=>"titleproper", :attributes=>{ :type => "filing" }, :index_as=>[:displayable])
    ...
    t.unitdate_bulk(:path=>"archdesc/did/unitdate[@type='bulk']", :index_as=>[:displayable])
    t.unitdate_inclusive(:path=>"archdesc/did/unitdate[@type='inclusive']", :index_as=>[:displayable])
